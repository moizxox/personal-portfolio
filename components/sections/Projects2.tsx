...
const projects = [
  {
    title: "React Headless Plugin",
    description: "Headless WordPress plugin using React, Redux, Tailwind, Stripe integration and custom WordPress dashboard.",
    technologies: "React, Redux, Tailwind, Stripe, WordPress",
    liveDemo: "",
    github: "",
  },
  {
    title: "Smart AI Linker Plugin",
    description: "WordPress plugin built with core PHP integrating Deepseek AI for auto internal linking, fixing broken links, and adding images.",
    technologies: "PHP, WordPress, Deepseek AI",
    liveDemo: "",
    github: "",
  },
  {
    title: "Painting Business Portfolio",
    description: "A full painting business website using Elementor for a clean, modern portfolio design.",
    technologies: "WordPress, Elementor",
    liveDemo: "",
    github: "",
  },
  {
    title: "Ecommerce Marketing Theme",
    description: "Custom ecommerce theme built with pure HTML, CSS, Bootstrap, and PHP for WordPress.",
    technologies: "HTML, CSS, Bootstrap, WordPress, PHP",
    liveDemo: "",
    github: "",
  },
  {
    title: "Gemini Clone",
    description: "Fully responsive Gemini clone built in React and Tailwind.",
    technologies: "React, Tailwind",
    liveDemo: "",
    github: "",
  },
  {
    title: "Employee Management Plugin",
    description: "A complete employee management plugin built in WordPress using PHP and MySQL.",
      ...
      <div className="container">
        <div className="rounded-3 border border-1 position-relative overflow-hidden">
          <div className="box-linear-animation position-relative z-1">
                    ...
                    {projects.map((project, index) => (
                      <SwiperSlide key={index}>
                        <div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
                          <div className="row">
                            <div className="col-lg-12 ps-lg-5 mt-5 mt-lg-0">
                              ...
                              <div className="d-flex flex-wrap align-items-center gap-3 mt-7">
                                ...
                                {project.github && (
                                  <Link href={project.github} target="_blank" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
            ...
            <img className="position-absolute top-0 start-0 z-0" src="assets/imgs/home-page-2/projects/bg.png" alt="bg" />
          </div>
        </div>
      </div>
    </div>
